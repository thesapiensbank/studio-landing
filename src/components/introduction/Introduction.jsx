...
const Introduction = () => {
  return (
    <div className="h-screen overflow-hidden w-full bg-primary flex flex-col justify-center items-center relative animate-bg opacity-0">
      <h1 className="text-white lg:text-[13rem] md:text-[10rem] text-7xl font-intro2 absolute lg:top-72 md:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 one uppercase">
        Hello!
      </h1>
      <h1 className="text-white lg:text-[13rem] md:text-[10rem] text-7xl font-intro2 absolute lg:top-72 md:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 two w-full text-center uppercase">
        we are
      </h1>
