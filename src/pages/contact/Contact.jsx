      ...
      <div className="lg:w-4/5 h-screen bg-black lg:ml-auto text-white relative">
        ...
        <div className="flex flex-col 2xl:w-1/2 lg:w-7/12 md:w-2/3 w-11/12 h-max absolute md:top-28 top-10 left-1/2 -translate-x-1/2  xl:space-y-5 lg:space-y-6 space-y-5">
          <div className="flex -space-x-6">
            ...
            <div className="relative bg-[#1e1e1e] w-full  lg:h-28 h-24 flex flex-col justify-center p-5 px-10 rounded-lg  font-thin underline md:text-base text-sm">
          ...
          <div className="flex -space-x-6">
            ...
            <div className="relative bg-[#1e1e1e] w-full  lg:h-28 h-24 flex flex-col justify-center p-5 px-10 rounded-lg  font-thin md:text-base text-sm">
              <p>+91 9876543210</p>
              <p>022 25869746</p>
            </div>
          </div>
