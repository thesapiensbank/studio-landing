        ...
        <div className='w-full lg:flex'>
          ...
          <div className='lg:w-4/5 w-full h-max bg-black lg:ml-auto 2xl:mb-5 lg:mb-4 mb-4 relative'>
            <div className='h-full w-full text-white aspect-video sticky lg:top-0'>
              <div className='2xl:h-[596px] lg:h-[596px] h-full w-full'>
                <video
                  src='https://ipfs.io/ipfs/bafybeiatupjdajpcq7wgasccenrpislrbqcvargwjl2c5jz4yiwfedtaxa/showreel.mov'
                  controls='true'
                  className='object-cover h-full w-full'
                  poster='https://ipfs.io/ipfs/bafybeihqyb4kzgfmlcqz3gghznmn24nyso6cukb63te3ikmjlk6j2evvpe/504872D7-BA77-44E8-9932-DEA8E942F689.jpeg'
                ></video>
              </div>
            ...
            <div className='lg:sticky bg-black'>
              <div className='flex md:flex-row flex-col w-full md:space-x-5 space-y-5 md:space-y-0 text-white lg:pt-10 2xl:-mt-24 2xl:mb-16 lg:mb-16 lg:mt-0 my-7 lg:text-md xl:text-base lg:px-11 md:px-6 px-5 '>
